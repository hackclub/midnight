<script lang="ts">
  ...
  async function handleSubmit(event: Event) {
    ...
    if (!email.trim() || !firstName.trim() || !lastName.trim() || !birthday.trim()) {
    ...
    if (age >= 19) {
      errorMessage = 'Midnight is for teenagers 18 and under. You must be 18 or younger to attend.';
      return;
    }
...
<section class="bg-[#f24b4b] relative w-full h-screen flex flex-col items-center overflow-hidden main-container">
    ...
    <div class="mobile-card">
      <form on:submit={handleSubmit} class="flex flex-col w-full">
        <div class="form-content">
          ...
          <p class="font-['PT_Sans',_sans-serif] text-[18px] text-black leading-[1.2] mb-[32px]">
            Midnight is for teenagers 18 and under
          </p>
        
        <div class="grid grid-cols-1 gap-y-[24px] mb-[32px]">
          <div class="flex flex-col gap-[8px]">
            <label for="firstName-mobile" class="font-['PT_Sans',_sans-serif] text-[20px] text-black leading-[1.2]">
              First Name
            </label>
            <input
              id="firstName-mobile"
          ...
          <div class="flex flex-col gap-[8px]">
            <label for="lastName-mobile" class="font-['PT_Sans',_sans-serif] text-[20px] text-black leading-[1.2]">
              Last Name
            </label>
            <input
              id="lastName-mobile"
          ...
          <div class="flex flex-col gap-[8px]">
            <label for="email-mobile" class="font-['PT_Sans',_sans-serif] text-[20px] text-black leading-[1.2]">
              Email
            </label>
            <input
              id="email-mobile"
          ...
          <div class="flex flex-col gap-[8px]">
            <label for="birthday-mobile" class="font-['PT_Sans',_sans-serif] text-[20px] text-black leading-[1.2]">
              Birthday
            </label>
            <input
              id="birthday-mobile"
        ...
        {#if errorMessage}
          <p class="text-white font-['PT_Sans',_sans-serif] text-lg bg-red-900 bg-opacity-50 px-4 py-3 rounded-lg mb-6 text-center">
            {errorMessage}
          </p>
        {/if}
        ...
        <div class="flex flex-col items-center w-full gap-[24px]">
          <button 
            ...
            disabled={isSubmitting}
          >
            <span class="front font-['Moga',_sans-serif] text-[#fee1c0] text-[32px] text-center tracking-[1.92px] leading-[normal]">
              {#if isSubmitting}
          ...
          <a href="/faq" class="px-[18px] py-[8px] bg-[#fffbf6] rounded-[8px] text-center flex flex-col">
  ...
  <!-- Desktop Layout -->
  <div class="desktop-layout relative flex-col items-center justify-center md:justify-end flex-1 w-full px-4 overflow-y-auto hidden lg:flex">
    ...
    <div class="relative z-20 flex flex-col items-start w-[48vw] max-w-[960px] max-h-[70vh] px-[0.5vw] overflow-y-auto">
      <form on:submit={handleSubmit} class="flex flex-col w-full">
        ...
        <p class="font-['PT_Sans',_sans-serif] text-[clamp(18px,_1.5vw,_44px)] text-black leading-[1.2] mb-[2vh]">
          Midnight is for teenagers 18 and under
        </p>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-[1.2vw] gap-y-[2vh] mb-[3vh]">
          <div class="flex flex-col gap-[0.4vh]">
            <label for="firstName" class="font-['PT_Sans',_sans-serif] text-[clamp(20px,_1.5vw,_44px)] text-black leading-[1.2]">
              First Name
            </label>
            <input
              id="firstName"
              ...
              required
              autocomplete="given-name"
              class="w-full h-[clamp(40px,_3.5vh,_68px)] px-[0.6vw] py-[0.5vh] rounded-[0.4vw] bg-[#fffbf6] font-['PT_Sans',_sans-serif] text-[clamp(18px,_1.3vw,_38px)] text-black leading-[1.2] focus:outline-none focus:ring-2 focus:ring-black border-0"
              disabled={isSubmitting}
              placeholder="William"
            />
          </div>
          ...
          <div class="flex flex-col gap-[0.4vh]">
            <label for="lastName" class="font-['PT_Sans',_sans-serif] text-[clamp(20px,_1.5vw,_44px)] text-black leading-[1.2]">
              Last Name
            </label>
            <input
              id="lastName"
          ...
          <div class="flex flex-col gap-[0.4vh]">
            <label for="email" class="font-['PT_Sans',_sans-serif] text-[clamp(20px,_1.5vw,_44px)] text-black leading-[1.2]">
              Email
            </label>
            <input
              id="email"
          ...
          <div class="flex flex-col gap-[0.4vh]">
            <label for="birthday" class="font-['PT_Sans',_sans-serif] text-[clamp(20px,_1.5vw,_44px)] text-black leading-[1.2]">
              Birthday
            </label>
            <input
              id="birthday"
        ...
        {#if errorMessage}
          <p class="text-white font-['PT_Sans',_sans-serif] text-[clamp(16px,_1vw,_24px)] bg-red-900 bg-opacity-50 px-[1vw] py-[0.8vh] rounded-lg mb-[2vh] text-center">
            {errorMessage}
          </p>
        {/if}
        ...
        <div class="flex flex-col items-center w-full gap-[2vh]">
          <button 
            ...
            disabled={isSubmitting}
          >
            <span class="front font-['Moga',_sans-serif] text-[#fee1c0] text-[clamp(28px,_2vw,_64px)] text-center tracking-[0.06em] leading-[normal]">
              {#if isSubmitting}
                <span class="flex items-center gap-2">
                  <svg class="animate-spin h-[clamp(20px,_1.5vw,_40px)] w-[clamp(20px,_1.5vw,_40px)]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                  </svg>
                  SUBMITTING...
          ...
          <a href="/faq" class="px-[1vw] py-[0.5vh] bg-[#fffbf6] rounded-[0.4vw] text-center flex flex-col mb-[1vh]">
