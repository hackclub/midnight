...
>
    ...
    >
        ...
        <div class="flex items-center justify-center no-select">
            <p>{project.approvedHours ? `${project.approvedHours} hours` : 'No hours'}</p>
    ...
    >
        ...
        <p class="text-[2vh] opacity-80 pt-[0.5vh] px-[1vw] line-clamp-2 overflow-hidden text-ellipsis">{project.desc}</p>
    </div>
</div>
